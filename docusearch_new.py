...
st.title("Document Search and Chat")
...
st.sidebar.info("This app searches and chats with documents using the 'hkunlp/instructor-xl' model for embeddings and GPT-4o-mini for chat.")
